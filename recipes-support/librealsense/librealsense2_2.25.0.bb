...
do_install_append() {
    ...
    rm -f "${D}${includedir}/GLFW/glfw3native.h"
    rm -f "${D}${includedir}/GLFW/glfw3.h"
    rm -f "${D}${libdir}/cmake/glfw3/glfw3Config.cmake"
    rm -f "${D}${libdir}/cmake/glfw3/glfw3Targets.cmake"
    rm -f "${D}${libdir}/cmake/glfw3/glfw3Targets-noconfig.cmake"
    rm -f "${D}${libdir}/cmake/glfw3/glfw3ConfigVersion.cmake"
    rm -f "${D}${libdir}/pkgconfig/glfw3.pc"
}
